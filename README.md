    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <small>estimation from 178mb of code in 9953 edited files across 2455 commits</small>
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    <mask id="languages-bar">
                        <rect x="0" y="0" width="460" height="8" fill="white" rx="5"/>
                    </mask>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="0" height="8" fill="#d1d5da"/>
                    <rect mask="url(#languages-bar)" x="0" y="0" width="276.51615255909735" height="8" fill="#f1e05a"/>
                    <rect mask="url(#languages-bar)" x="276.51615255909735" y="0" width="76.77152601999228" height="8" fill="#3178c6"/>
                    <rect mask="url(#languages-bar)" x="353.28767857908963" y="0" width="53.60654682740572" height="8" fill="#a91e50"/>
                    <rect mask="url(#languages-bar)" x="406.89422540649537" y="0" width="53.105774593504655" height="8" fill="#3572A5"/>
                </svg>
